...
ggplot(kenya_plot,aes(x = day_since_first_report, y = cases))+
  ...
  scale_x_continuous(breaks  = seq(0,150,10))+scale_y_continuous(breaks  = seq(0,max(kenya_plot$cases)+5,300))+
...
ggplot(data=df_africa, aes_string(x=paste0("reorder(Country_Region",", Confirmed)"),y="Confirmed")) + coord_flip()+
  ...
  theme(axis.text.x=element_blank(),axis.ticks=element_blank(),
        legend.position ="none")+scale_fill_brewer(palette = "Reds")+ylim(c(0,250000))
...
knitr::include_graphics("C:/Users/Admin/Documents/naominganga.github.io/map/infographics/July_1st_2020.jpeg")
```

### **Nairobi county cases** 

```{r, echo=FALSE, fig.cap="A caption", out.width = '100%'}
knitr::include_graphics("C:/Users/Admin/Documents/naominganga.github.io/map/infographics/spread_of_covid_19_Nai_6th July.jpg")
...
```{r, echo=FALSE, fig.cap="A caption", out.width = '100%'}
knitr::include_graphics("C:/Users/Admin/Documents/naominganga.github.io/map/infographics/spread_of_covid_19_mombasa_6th_July_V2.jpg")
