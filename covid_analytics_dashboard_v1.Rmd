...
ggplot(data=df_africa, aes_string(x=paste0("reorder(Country_Region",", Confirmed)"),y="Confirmed")) + coord_flip()+
  ...
  theme(axis.text.x=element_blank(),axis.ticks=element_blank(),
        legend.position ="none")+scale_fill_brewer(palette = "Reds")+ylim(0,33000)
...
knitr::include_graphics("C:/Users/Admin/Documents/naominganga.github.io/map/infographics/kenya_11th_aug_2020.jpg")
```
