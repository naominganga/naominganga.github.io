...
ggplot(data=df_africa, aes_string(x=paste0("reorder(Country_Region",", Confirmed)"),y="Confirmed")) + coord_flip()+
  ...
  theme(axis.text.x=element_blank(),axis.ticks=element_blank(),
        legend.position ="none")+scale_fill_brewer(palette = "Reds")+ylim(0,15000)
...
ggplot(data=df_africa, aes_string(x=paste0("reorder(Country_Region",", Active)"),y="Active")) + coord_flip()+
  ...
  theme(axis.text.x=element_blank(),axis.ticks=element_blank(),
        legend.position ="none")+scale_fill_brewer(palette = "Reds")+ylim(c(0,140000))
...
knitr::include_graphics("C:/Users/Admin/Documents/naominganga.github.io/map/infographics/covid19 cases as of 12th July 2020.jpeg")
```

### **Nairobi county cases** 

```{r, echo=FALSE, fig.cap="A caption", out.width = '100%'}
knitr::include_graphics("C:/Users/Admin/Documents/naominganga.github.io/map/infographics/spread_of_covid_19_Nai_12th_July.jpg")
...
```{r, echo=FALSE, fig.cap="A caption", out.width = '100%'}
knitr::include_graphics("C:/Users/Admin/Documents/naominganga.github.io/map/infographics/spread_of_covid_19_mombasa_12th_July.jpg")
